...
ConfigWidget::ConfigWidget()
{
  ...
  robot_settings = new QSettings;
    ...
    geo_vars->addChild(field_vars);
        ...
        ADD_VALUE(field_vars,Double,Field_Penalty_Width,2.00,"Penalty width")
        ADD_VALUE(field_vars,Double,Field_Penalty_Depth,1.00,"Penalty depth")
        ADD_VALUE(field_vars,Double,Field_Penalty_Point,1.00,"Penalty point")
